...
class TransformerModelIMDB(nn.Module):
    def __init__(self,embed_dim,num_heads,d_k,ff_dim,max_len,vocab_size,d_v=None):
        super(TransformerModelIMDB,self).__init__()
